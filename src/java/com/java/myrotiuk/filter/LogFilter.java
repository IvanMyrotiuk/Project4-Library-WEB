...
/**
 * Class<code> LogFilter</code> filter for creating log of users that try to log in
 *
 * @version 1.0
...
public class LogFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(userEmail != null){
            logger.info("Remote address:"+ipAddress+"; Remote host:"+host+" try to access "+userEmail);
        }
        
//        HttpServletRequest req = (HttpServletRequest) request;
//        HttpSession session = req.getSession();
//        logger.info("session=" + session.getAttribute("forFilterUserEmail"));
