...
/**
 * Class<code> FontTagHandler</code> for creating tag with specific font
 *
 * @version 1.0
 * @author Ivan Myrotiuk
 * @since 23-05-2015
 */
public class FontTagHandler extends BodyTagSupport {
    
    private static Logger logger = Logger.getLogger(FontTagHandler.class);
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            JspWriter out = pageContext.getOut();
            out.print("<br/><br/><br/><br/><br/><center><font size ='"+size+"' color='"+color+"'>");
            
        } catch (IOException ex) {
            logger.error("Problem with a start of custom teg", ex);
        }
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in FontTagHandler tag", ex);
    }
